  ...
  <div class="capa">
    <div class="texto-cadastro">
      ...
      <div class="container">
        ...
        <div class="col-md-4">
          <form method="post" action="editando-produto.php" id="formAdicionar">
            ...
            <div class="form-group">
              <input type="double" class="form-control" id="preco" name="preco" placeholder="Preço R$ - Use o ponto ao invés de virgula " required="requiored" value="<?php echo $linha['preco']; ?>">
            </div>

            <button type="submit" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-pencil"></span> Editar</button>
            <a href="page-prod-editar.php" class="btn btn-primary btn-lg">&#9754 Voltar</a>
            <br />
            <?php
            if ($cadastrado == 1) {
              ?>
