  ...
  <div class="img-back-venda">
    ...
    <div class="capa">
      <div class="texto-modulos" style="padding-top: 200px;padding-bottom: 200px;">
        <a href="..\gerenciar_produtos\page-prod-adicionar.php" class="btn btn-custom item-modulos btn-lg">Fechamento</a>
        <a href="..\gerenciar_produtos\page-prod-consultar.php" class="btn btn-custom item-modulos btn-lg">&#9675 Consultar</a>
        <br />
        <a href="..\gerenciar_produtos\page-produtos.php" class="btn btn-custom item-modulos btn-lg">&#10000 Cancelar</a>
