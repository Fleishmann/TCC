...
$sql = "SELECT * FROM produtos WHERE (nomeProduto LIKE '%$nome%' AND codprodControle LIKE '%$id%' AND marca LIKE '%$marca%' AND modelo LIKE '%$modelo%' AND quantidade LIKE '%$quantidade%') AND idEmpresa = " . $_SESSION['id'] . " ORDER BY codprodControle";
