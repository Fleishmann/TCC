...
<body>
  ...
  <div class="capa">
    <div class="texto-cadastro">
      <h1 id="texto-cadastro">Consultar Estoque</h1>
      ...
      <div class="container">
        ...
        <div class="col-md-4">
          <form method="post" action="consulta-estoque.php" id="formConsultaEstoque">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="quantidade" name="quantidade" placeholder="Quantidade" style="width:200px;margin-top: -34px;margin-left: 350px;">
              ...
              <a href="../page-estoque.php" class="btn btn-primary btn-lg" style="margin-top: 50px;">☚ Voltar</a>
            </div>
          </form>
        </div>
      </div>
